...
|  |  | US5_T5 | Publish the controlled school-map widget and validate Melbourne Connect default centre, 1 km default distance, kilometre units, controlled marker visibility, sector colours, marker popup basics, and wide-screen shell centring. | @Fazheng Xu and @Conghao Lin | Done |  |  |  | P | IP | R | IP | D |  | @Fazheng Xu generated the current page/widget evidence; QA confirmed the live page defaults to Melbourne Connect, 1 km, 6 nearby results, sector-coloured markers, and a centred wide-screen shell. |
...
|  |  | US6_T4 | QA invalid, empty, and no-result searches. | @Fazheng Xu and @Conghao Lin | Done |  |  |  | P | IP | R | IP | D |  | @Fazheng Xu prepared the no-match handling in the generated widget; QA verified the clear no-match state and guidance message. |
