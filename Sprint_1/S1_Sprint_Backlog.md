...
|  |  | US1_T2 | Compile and clean the building location data into a map-ready format, including coordinate checks and basic identifying fields. | @Fazheng Xu | Done | 3 |  |  |  | In Progress |  |  | In Progress |  |  | Completed |  |  |  |  |
|  |  | US1_T3 | Configure the WordPress map component to display the selected university building markers with distinguishable University of Melbourne and RMIT marker colours. | @Fazheng Xu | Done | 3 |  |  |  |  |  |  | In Progress |  |  | Completed |  |  |  |  |
|  |  | US1_T4 | Validate building marker visibility, colour distinction, and selection behaviour against the acceptance criteria. | @Conghao Lin | Done | 3 |  |  |  |  |  |  |  |  |  | Queued | Completed |  |  | Final retest |
|  |  | US1_T5 | Monitor US-01 delivery progress and update sprint artefacts to reflect current status. | @Manting Yu | Done | 3 | Started |  |  |  |  |  |  |  |  |  | Completed |  |  |  |
...
|  |  | US2_T2 | Compile and clean the required City of Melbourne area library location data for inclusion in the shared WordPress map view. | @Fazheng Xu | Done | 2 |  |  |  | In Progress | Scope clarified |  | In Progress |  |  | Completed |  |  |  |  |
|  |  | US2_T3 | Add the selected City of Melbourne area library marker to the shared map and check that the approved WordPress configuration supports consistent marker behaviour. | @Jiajun Jiang | Done | 2 |  |  |  |  | Scope clarified |  | In Progress |  |  | Completed |  |  |  |  |
|  |  | US2_T4 | Validate library marker behaviour and consistency against the acceptance criteria. | @Conghao Lin | Done | 2 |  |  |  |  |  |  |  |  | Queued | Completed |  |  |  | Evidence reconciled |
|  |  | US2_T5 | Monitor US-02 delivery progress and ensure artefact consistency between Sprint Backlog and stand-up log. | @Manting Yu | Done | 2 | Started |  |  |  |  |  |  |  |  | Completed |  |  |  |  |
...
|  |  | US3_T2 | Configure the marker detail interaction and popup layout for the selected Sprint 1 locations. | @Jiajun Jiang | Done | 2 |  |  |  |  |  |  | In Progress |  | Completed |  |  |  |  |  |
|  |  | US3_T3 | Link the prepared marker data to the basic detail display for each selected location. | @Fazheng Xu | Done | 2 |  |  |  |  |  |  |  |  | Completed |  |  |  |  |  |
|  |  | US3_T4 | Validate the detail display for correctness, completeness, and acceptance-criteria coverage across the selected Sprint 1 locations. | @Conghao Lin | Done | 2 |  |  |  |  |  |  |  |  | Completed |  |  |  |  | Evidence reconciled |
...
- The Est. Effort (SP) column repeats the story-point estimate for each task row under the same user story to preserve traceability; it does not represent separate task-level estimation.
